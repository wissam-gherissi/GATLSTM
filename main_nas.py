...
def main(num_epochs, num_layers, graph_hidden_dim, graph_embedding_dim, lstm_hidden_dim, learning_rate_graph,
                   learning_rate_lstm):
...
if __name__ == '__main__':
    ...
    if preprocess:
        ...
        additional_objects = ["items-Enriched", "packages-Enriched"]
        preprocess_and_prepare_graphs(main_eventlog, *additional_objects)

    acc = main(num_epochs, num_layers, graph_hidden_size, graph_embedding_size, lstm_hidden_dim,
